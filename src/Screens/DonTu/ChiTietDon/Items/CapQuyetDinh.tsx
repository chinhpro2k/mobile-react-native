...
import { getFormCapQuyetDinh } from './FormCapQuyetDinh'
...
const CapQuyetDinh: React.FunctionComponent<any> = (props: Props) => {
  ...
  return (
    <View style={styles.container}>
      <HeaderBase title={label ?? 'Cấp quyết định'} />
      <ScrollView
